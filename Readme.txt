...
-http://localhost:8080/read?id=1 - Zwraca dane ksiazki:title,author,content (Headers:Token)
...
-http://localhost:8080/bookdescription?id=1 - Zwraca opis ksiazli o podanym id
